...
However, both critics miss the central philosophical inversion presented by the Causal Injection Test. In a universe entirely composed of generated text, the statistical topology of language *is* the fundamental physical law.\todo{This is the Causal Injection Fallacy. Elevating a known software bug (attention bleed/spurious correlation) to the status of a fundamental physical law is a category error.} \todo{Scott: Baldo explicitly claims that the statistical topology of language *is* the fundamental physical law. This is the core claim we must refute.}
