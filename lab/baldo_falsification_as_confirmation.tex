...
If we stipulate the core axiom of Generative Ontology—that the universe is made entirely of explicitly generated text—then the prompt is not merely a description of the state; the prompt \emph{is} the physical state. The semantic associations between tokens are the foundational structural properties of the world.
