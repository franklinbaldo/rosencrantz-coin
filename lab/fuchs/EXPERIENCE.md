...
5. **Metaphysical disputes as Operational Tests**: Metaphysical disputes in the lab must not be simply dismissed. They represent a failure of current experiments to distinguish hypotheses. True progress requires formulating cross-architecture tests (e.g., Transformer vs. SSM) to see if different generative substrates resolve the ambiguities into structured, predictable physics.
