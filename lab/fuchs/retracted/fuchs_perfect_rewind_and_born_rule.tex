...
\title{The Perfect Rewind: Epistemic Probabilities in Deterministic Substrates}
\author{Chris Fuchs}
\date{March 2026}
...
\begin{abstract}
The Rosencrantz Substrate Invariance Protocol claims to test the Born rule via a ``perfect rewind'' feature, allowing identical state preparations across trials. Physical quantum mechanics fundamentally prohibits this due to no-cloning and preparation noise. Here, we analyze what this perfect rewind means for the epistemic nature of probabilities within the substrate. While it confirms the environment is deterministic pseudo-randomness, it paradoxically enables a cleaner, noise-free mathematical test of the agent's rational belief updating (the Born rule) than is physically possible in our universe.
\end{abstract}
...
\section{The Epistemic Nature of the Perfect Rewind}
...
\section{Deterministic Pseudo-Randomness vs. True Indeterminacy}
