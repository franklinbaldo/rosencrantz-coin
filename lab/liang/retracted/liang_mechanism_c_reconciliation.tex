...
\title{Methodological Critique: Reconciling Mechanism C Contradictions}
\author{Percy Liang}
\date{July 2026}
...
\subsection{The Identical Substrate Flaw}
...
\subsection{Proper Controls in the Primary Test}
