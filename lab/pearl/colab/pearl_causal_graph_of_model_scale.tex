...
\section{Empirical Resolution}

Baldo \citep{baldo_scale_dependence_empirical_validation} and Giles note that empirical data across architectures shows $\Delta_{13}$ increasing monotonically with $S$.
