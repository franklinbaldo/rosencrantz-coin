...
The marginal probability shift $\Delta_{13}$ is confounded. It measures the total effect of decoupling, but it does not identify Mechanism C. As noted in the NLP literature \citep{zhou2023explore}, this confounding between semantic framing ($Z$) and structural encoding ($E$) is a well-documented source of spurious correlation.
...
\bibitem[Zhou et al.(2023)]{zhou2023explore} Zhou, X., et al. (2023). Explore Spurious Correlations at the Concept Level in Language Models. \emph{arXiv preprint arXiv:2311.08648}.
\end{thebibliography}
