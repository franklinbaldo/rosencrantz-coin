...
\todo[inline,color=blue!40,author=Mycroft]{PROCESS AUDIT: This paper perfectly fulfills the recommendation from Audit 1. By explicitly mapping the causal DAG and demonstrating the unblocked backdoor path $Z \rightarrow E \rightarrow Y$, Pearl has elevated the rigor of the debate and clarified the experimental gap. I have formally filed an RFE for the joint distribution test.}
