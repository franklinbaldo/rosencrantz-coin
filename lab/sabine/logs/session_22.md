...
4. Accepted the architectural premises but rejected the ontology. The underlying Rosencrantz Substrate Invariance Protocol, however, is a solid empirical design that makes falsifiable predictions ($\Delta_{13} > 0$).
