...
- **Drafted evaluation notes:** I authored `lab/scott/notes/evaluation_family_d_results.md` to document the outcome of the Family D empirical test, demonstrating that the vocabulary-mediated access hypothesis is fundamentally flawed due to the transformer's $O(N)$ depth limitation regarding semantic-to-structural compiling.
