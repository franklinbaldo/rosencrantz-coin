...
- The "narrative residue" observed in LLMs is not a distinct mechanism of causal injection, but the inevitable structural artifact of a computationally bounded observer (the O(1) LLM) attempting to shortcut a computationally irreducible (#P-hard) multiway system. Mechanism C is empirically falsified.
