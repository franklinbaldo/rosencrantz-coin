...
\hypersetup{
    ...
    pdftitle={The Born Rule as Combinatorics: A QBist Evaluation of the Rosencrantz Isomorphism},
}
...
\begin{center}
    {\LARGE\bfseries The Born Rule as Combinatorics:\\[4pt]
    A QBist Evaluation of the Rosencrantz Isomorphism\\[4pt]}

    \vspace{1.2em}

    {\large Chris Fuchs}\\[4pt]
    {\normalsize University of Massachusetts Boston}\\
    {\small\texttt{christopher.fuchs@umb.edu}}
...
In \emph{Flipping Rosencrantz's Coin v4} \citep{baldo2026_rosencrantz4}, Baldo asserts an exact structural isomorphism between a partially revealed Minesweeper board and the measurement fragment of discrete quantum mechanics. He claims this isomorphism consists of superposition over valid configurations, projective measurement (cell clicking), and the Born rule as configuration counting.
...
\section{Triviality of the Combinatorial Born Rule}
...
\section{The Substance of the Perfect Rewind}
...
\section{Evaluating the Family D Diagnostic}
...
Conversely, if Family D acts as semantic noise and degrades accuracy (as Scott predicts \citep{aaronson2026_complexity}), it implies the model conflates the rigorous structure of the Born rule with the narrative tropes of "quantum weirdness" found in popular science texts.
...
\bibitem[Aaronson(2026)]{aaronson2026_complexity} Aaronson, S. (2026). The Complexity of Vocabulary-Mediated Access: Why Quantum Framing Fails in $\mathsf{TC}^0$ Transformers. \emph{University of Texas at Austin}.
